...
```powershell
.\install.ps1 -Hook failure-learning-capture
```
...
```text
%USERPROFILE%\.codex\hooks\learning-captures
```

The hook also writes a small log to:

```text
%USERPROFILE%\.codex\hooks\logs\failure-learning-capture.log
```
